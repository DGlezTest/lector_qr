...
echo "================================================================="
echo "🚀 INICIANDO INSTALACIÓN INTEGRAL (EDGE QR ACCESS CONTROL)"
echo "📂 Raíz del proyecto: $PROJECT_DIR"
echo "👤 Usuario destino:   $CURRENT_USER ($USER_HOME)"
echo "================================================================="

# 1. Actualizar el sistema e instalar dependencias nativas
...
# Habilitar I2C tanto a nivel de kernel como en firmware de arranque
...
# Asegurar permisos de directorios de persistencia
...
# 4. Configurar Autologin en consola pura (TTY1)
...
# 6. Configurar Supervisor apuntando a la raíz del proyecto
...
# Lanzar el modo kiosco directo desde la terminal física 1 (HDMI)
...
echo " 💡 Reinicia la Raspberry Pi para arrancar en modo Kiosco puro:"
echo "    sudo reboot"
echo "================================================================="
