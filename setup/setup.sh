...
echo "================================================================="
echo "   INICIANDO INSTALACIÓN MAESTRA (MÉTODO GLOBAL): LECTOR QR      "
echo "================================================================="
...
# Añadimos libcap-dev y los paquetes oficiales de la cámara de la Raspberry
...
# 📸 INSTALACIÓN GLOBAL DE PICAMERA2 CON SUDO
# Esto asegura que el sistema operativo maneje los drivers binarios directamente
echo "📸 Instaland picamera2 de forma global en el sistema operativo..."
sudo apt-get install -y python3-picamera2 || sudo pip3 install picamera2 --break-system-packages

# 2. Crear y configurar el Entorno Virtual (venv) HÍBRIDO
echo "🐍 [2/7] Configurando entorno virtual integrado con el sistema (.venv)..."
cd "$PROJECT_DIR"

# El secreto: --system-site-packages le permite al .venv heredar picamera2 y libcamera globales
if [ ! -d ".venv" ]; then
...
# Activar venv de forma segura para instalar librerías estándar de Python
...
# 4. Configurar el inicio automático en Consola con Login Automático
...
# 5. Permisos de Hardware Gráfico para el usuario 'pi'
...
# Ejecutamos usando la ruta de tu .venv, la cual ahora heredará limpiamente la picamera2 global
